...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/csv-inspector`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/convert`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/merge`, changeFrequency: "monthly", priority: 0.8 },
