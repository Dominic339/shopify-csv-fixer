...
/**
 * IMPORTANT:
 * issueMetaRegistry.ts imports SHOPIFY_ISSUE_META by name.
 * Do not rename this export unless you update the registry too.
 */
export const SHOPIFY_ISSUE_META: IssueMetaMap = {
  "shopify/missing_required_header": {
    ...
    whyPlatformCares: "Shopify requires certain columns to correctly create or update products and variants.",
    howToFix: "Add the missing column(s). Download the Shopify sample CSV for the correct header list.",
    category: "required",
    blocking: true,
    autoFixable: false,
  },
  ...
  "shopify/blank_handle": {
    ...
    whyPlatformCares: "Shopify groups variant rows by URL handle. Missing handles can break grouping and updates.",
  ...
  "shopify/invalid_handle": {
    ...
    whyPlatformCares: "Invalid handles can cause Shopify import errors and broken product URLs.",
    howToFix: "Use lowercase letters, numbers, and hyphens only (no spaces or special characters).",
    category: "handle",
    blocking: true,
    autoFixable: true,
  },
  ...
  "shopify/invalid_boolean_published": {
    ...
    whyPlatformCares: "Shopify expects TRUE or FALSE (or blank). Invalid values can block import.",
  ...
  "shopify/compare_at_lt_price": {
    ...
    whyPlatformCares: "Compare-at price is meant to represent an original higher price (for sales).",
    howToFix: "Ensure Compare-at price is greater than or equal to Price, or leave it blank.",
    category: "pricing",
    blocking: false,
    autoFixable: false,
  },
  ...
  "shopify/negative_inventory": {
    ...
    howToFix: "Use 0 or a positive quantity, or configure backorders using Continue selling settings.",
    category: "inventory",
    blocking: false,
    autoFixable: false,
  },
  ...
  "shopify/invalid_image_position": {
    ...
    whyPlatformCares: "Image position controls ordering; invalid values can cause unpredictable ordering.",
  ...
  "shopify/option_order_invalid": {
    ...
    howToFix: "Fill Option1 before using Option2, and fill Option2 before Option3.",
    category: "variant",
    blocking: true,
    autoFixable: false,
  },
  ...
  "shopify/options_not_unique": {
    ...
    whyPlatformCares: "Shopify requires each variant option combination to be unique.",
  ...
  "shopify/blank_price": {
    ...
    whyPlatformCares: "Shopify requires a price for variants when creating products.",
  ...
  // ✅ NEW (Step 1): Stronger duplicate SKU detection across different URL handles
  "shopify/duplicate_sku_across_products": {
    ...
    howToFix:
      "Make SKUs unique across your catalog, or confirm you truly intend to reuse SKUs across multiple products.",
    category: "variant",
    blocking: false,
    autoFixable: false,
  },
  ...
  "shopify/handle_title_mismatch": {
    ...
    howToFix: "Use a single consistent Title for all rows under the same URL handle (variants and image rows).",
    category: "handle",
    blocking: false,
    autoFixable: false,
  },
  ...
  "shopify/option_name_inconsistent": {
    ...
    howToFix:
      "Use the same Option1/Option2/Option3 names for every variant row under the same URL handle.",
    category: "variant",
    blocking: false,
    autoFixable: false,
  },
  ...
  "shopify/duplicate_image_position": {
    ...
    whyPlatformCares: "Image position controls ordering; duplicates can lead to unpredictable ordering.",
